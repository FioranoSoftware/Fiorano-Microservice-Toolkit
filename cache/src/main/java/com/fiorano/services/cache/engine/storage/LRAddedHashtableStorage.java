...
/**
 * Removes the Least Recently Added entries from the Cache
 *
 * @author Venkat
 */
public class LRAddedHashtableStorage extends AbstractLRUHashtableStorage {
    public LRAddedHashtableStorage(CachePM configuration) {
